...
ggplot(ds, aes(x = quality, y = alcohol)) + 
  ...
  labs(x="quality (score between 0 and 10)uality",
       y="alcohol (% by volume)")
...
```{r echo=FALSE}
g1 = ggplot(ds, aes(x = citric.acid, y = fixed.acidity)) + 
  geom_point(aes(color = quality)) + 
  ggtitle("Continious Score") + 
  labs(x="citric.acid (g/dm^3)",
       y="fixed.acidity (g/dm^3)")
g2 = ggplot(ds, aes(x = citric.acid, y = fixed.acidity)) + 
...
```{r echo=FALSE}
g1 = ggplot(ds, aes(x = density, y = fixed.acidity)) + 
  geom_point(aes(color = quality)) + 
  ggtitle("Continious Score") + 
  labs(x="density (g/dm^3)",
       y="fixed.acidity (g/dm^3)")
g2 = ggplot(ds, aes(x = density, y = fixed.acidity)) + 
  geom_point(aes(color = rating)) + 
  ggtitle("Rated Score") + 
  labs(x="density (g/dm^3)",
       y="fixed.acidity (g/dm^3)")
...
```{r echo=FALSE}
g1 = ggplot(ds, aes(x = density, y = residual.sugar)) + 
  geom_point(aes(color = quality)) + 
  ggtitle("Continious Score") + 
  labs(x="density (g/dm^3)",
       y="residual.sugar (g/dm^3)")
g2 = ggplot(ds, aes(x = density, y = residual.sugar)) + 
  geom_point(alpha = 0.5, aes(color = rating)) + 
  ggtitle("Rated Score") + 
  labs(x="density (g/dm^3)",
       y="residual.sugar (g/dm^3)")
multiplot(g1, g2, cols = 2)
...
```{r echo=FALSE}
g1 = ggplot(ds, aes(x = alcohol, y = density, size = pH)) + 
  geom_point(aes(color = quality)) + 
  ggtitle("Continious Score") + 
  labs(x="alcohol (% by volume)",
       y="density (g/dm^3)")
g2 = ggplot(ds, aes(x = alcohol, y = density, size = pH)) + 
  geom_point(alpha = 0.5, aes(color = rating)) + 
  ggtitle("Rated Score") + 
  labs(x="alcohol (% by volume)",
       y="density (g/dm^3)")
...
ggplot(ds, aes(x = alcohol, y = density, size = pH)) + 
  geom_point(alpha = 0.5, aes(color = rating)) + 
  ggtitle("Plot One") + 
  labs(x="alcohol (% by volume)",
       y="density (g/dm^3)")
...
Finally I ended up with the argument that is,
Good wines have a high alcohol content, lesser density, medium pH and low density.